 ...
 */
const getTokens = (exports.getTokens = async userId => {
  // eslint-disable-line
  try {
 ...
 */
const getUser = (exports.getUser = async id => {
  // eslint-disable-line
  try {
 ...
 */
const getUserForKey = (exports.getUserForKey = async (key, userId) => {
  // eslint-disable-line
  try {
 ...
 */
const saveToken = (exports.saveToken = async (key, userId) => {
  // eslint-disable-line
  try {
 ...
 */
const updateOathForUser = (exports.updateOathForUser = async (
  userId,
  oauthToken
) => {
  try {
